...
AV_ASSUME_ROLE = os.getenv("AV_ASSUME_ROLE")
...
AV_SCAN_START_SQS_URL = os.getenv("AV_SCAN_START_SQS_URL")
...
AV_STATUS_SQS_URL = os.getenv("AV_STATUS_SQS_URL")
AV_STATUS_SNS_PUBLISH_CLEAN = os.getenv("AV_STATUS_SNS_PUBLISH_CLEAN", "True")
AV_STATUS_SQS_PUBLISH_CLEAN = os.getenv("AV_STATUS_SQS_PUBLISH_CLEAN", "True")
AV_STATUS_SNS_PUBLISH_INFECTED = os.getenv("AV_STATUS_SNS_PUBLISH_INFECTED", "True")
AV_STATUS_SQS_PUBLISH_INFECTED = os.getenv("AV_STATUS_SQS_PUBLISH_INFECTED", "True")
